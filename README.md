...
Hailo offers a set of expansion cards designed for computer vision models. This includes an **Evaluation Board** for compiling and **mPCIe boards** or **M.2 boards** for accelerating. **(*registration is required to access the documents)**
