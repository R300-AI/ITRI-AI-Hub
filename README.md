...
Genio is equipped with an **Arm GPU** and **MediaTek DLA**, providing 0.7 to 3 FTOPS of computing power. It supports General-Purpose I/O (GPIO) interfaces, making it suitable for developing AIoT-level computer vision applications.
