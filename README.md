...
Genio is equipped with an **Arm GPU** and **MediaTek DLA**, supporting General-Purpose I/O (GPIO) interfaces, making it suitable for developing AIoT-level computer vision applications.
