...
Genio is equipped with an **Arm GPU** and **MediaTek DLA**, providing 0.7~3 TOPs of computing power. It supports General-Purpose I/O (GPIO), making it suitable for developing AIoT-level computer vision applications.
