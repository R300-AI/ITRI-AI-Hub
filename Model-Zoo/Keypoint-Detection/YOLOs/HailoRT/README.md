...
* If you need to customise a paragraph for acceleration, you can use [Netron](https://netron.app/) to view the workflow of the model and fill in the desired <model_name> and corresponding <end_nodes> into `config.yaml` to complete the initial setup.
